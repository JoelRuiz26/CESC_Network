...
#
# Parallel version using 25 cores
# --------------------------------------------------------
...
library(vroom)
library(ggplot2)
library(future.apply)  # NEW

# ===========================
# Set parallel plan (25 workers)
# ===========================
...
# ===========================
# Function to compute network growth metrics IN PARALLEL
# ===========================
calculate_metrics_parallel <- function(edgelist, max_links) {
  future_lapply(1:max_links, function(i) {
...
# ===========================
cat("\nComputing growth metrics for A7 using 25 cores...\n")
metrics_A7 <- calculate_metrics_parallel(A7_Full, max_cutoff_links)

cat("\nComputing growth metrics for A9 using 25 cores...\n")
metrics_A9 <- calculate_metrics_parallel(A9_Full, max_cutoff_links)
...
# ===========================
ggsave(
  filename = "~/CESC_Network/5_Network_analisis/5_1_Subnetwork/5_1_2_1_GC_graph_elbow_paralel.png",
...
saveRDS(
  graph_A7_common, 
  file = "~/CESC_Network/5_Network_analisis/5_1_Subnetwork/5_1_2_2_Subnetwork_A7_paralel.rds"
)

saveRDS(
  graph_A9_common, 
  file = "~/CESC_Network/5_Network_analisis/5_1_Subnetwork/5_1_2_2_Subnetwork_A9_paralel.rds"
)
