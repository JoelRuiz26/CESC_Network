...
###Cargar resultados ###
ora_A7 <- vroom(file = "~/CESC_Network/7_Modularity/7_2_1_Ora7_600k.tsv")
ora_A9 <- vroom(file = "~/CESC_Network/7_Modularity/7_2_1_Ora9_600k.tsv")
# ====== PREPARAR DATA ======
# A7
df_A7 <- ora_A7 %>%
...
# ====== GUARDAR EN PDF ======
ggsave("~/CESC_Network/7_Modularity/7_3_1_Community_Size_Barplots.pdf", combined_plot, width = 14, height = 7)
